...
//            System.exit(1);
        ...
        ArrayList<Pais> todosPaises = gerPaises.listarTodos();
        System.out.println("Total países:" + todosPaises.size());
...
//            System.exit(1);
        ...
        System.out.println("Total Aeronaves:"+ todosAvioes.size());
        todosAvioes.forEach(System.out::println);



//        for(Aeronave aero: listarTodas)
...
//
        GerenciadorAeroportos gerAero = new GerenciadorAeroportos(gerPaises);
...
//            System.exit(1);
        ...
        todosAeroportos.forEach(System.out::println);
...
//        System.out.println();
        ...
        GerenciadorRotas gerRotas = new GerenciadorRotas(gerCias, gerAero, gerAero, gerAvioes);
...
//            System.exit(1);
        ...
        todasRotas.forEach(System.out::println);
